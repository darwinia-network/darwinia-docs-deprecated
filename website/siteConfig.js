...
const siteConfig = {
  ...
  headerLinks: [
    ...
    { href: "https://crab.network/", label: "Crab Home", external: true },
  ...
  */
  ...
  fonts: {
    ...
    myOtherFont: ['-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'sans-serif']
  },
